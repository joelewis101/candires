---
title: Fit candires mic models in stan - include baseline as covariate
author: "Joe Lewis"
  ...
  for (current_drug in drug) {
    ...
    data_df <-
      generate_mic_model_data(
        df_mics |>
          filter(!(psn == "4002" & swb_date == "2022-12-13" & species ==
"parapsilosis")), # is this real? Need to check - resistant baseline sample -
      # for now exlclude
        df_drug,
...
write_rds(list_out,
  here("data/fitted_stan_mic_models_baseline.rda"),
  compress = "gz"
)
```
